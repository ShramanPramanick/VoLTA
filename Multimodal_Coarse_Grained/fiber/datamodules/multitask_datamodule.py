...
class MTDataModule(LightningDataModule):
    def __init__(self, _config, dist=False, label_rate=0.10):
    ...
    def setup(self, stage):
        ...
        #dataset_len = self.train_dataset.__len__()
        #indices = torch.arange(int(dataset_len*self.label_rate))
        #self.train_dataset = data_utils.Subset(self.train_dataset, indices)
